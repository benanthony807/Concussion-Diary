...
public class Question2Screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                entry.reduceCurrent();
                Intent intent = new Intent(getApplicationContext(), Question1Screen.class);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!answerBox.getText().toString().equals("")) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), Question3Screen.class);
                    startActivity(intent);
                }
            }
        });
