...
public class IntQuestionScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    if (!answerBox.getText().toString().equals("") && !outOfRange(answerBox.getText().toString())) {
    ...
    private boolean outOfRange(String userResponse) {
        int val = Integer.valueOf(userResponse);
        return entry.getCurrentQuestion().contains("scale of 1-10") && (val < 1 || val > 10);
    }
}
